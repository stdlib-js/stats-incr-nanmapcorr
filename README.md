...
> Compute a moving sample absolute [Pearson product-moment correlation coefficient][pearson-correlation] incrementally, ignoring `NaN` values.
...
```javascript
incrnanmapcorr = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmapcorr@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmapcorr = require( 'path/to/vendor/umd/stats-incr-nanmapcorr/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmapcorr@umd/browser.js"></script>
```
...
-   Input values are **not** type checked. If provided `NaN` for either input value, the value is ignored and the accumulator function returns the current sample absolute correlation coefficient without updating the window. If non-numeric inputs are possible, you are advised to type check and handle accordingly **before** passing the value to the accumulator function.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nanmapcorr.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nanmapcorr

[test-image]: https://github.com/stdlib-js/stats-incr-nanmapcorr/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nanmapcorr/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nanmapcorr/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nanmapcorr?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nanmapcorr.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nanmapcorr/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nanmapcorr/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nanmapcorr/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nanmapcorr/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nanmapcorr/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nanmapcorr/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nanmapcorr/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nanmapcorr/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nanmapcorr/main/LICENSE
